...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.interest'
        db.add_column('django_messages_message', 'interest', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['facebookdata.Interest']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.interest'
        db.delete_column('django_messages_message', 'interest_id')
    ...
    models = {
        ...
        'django_messages.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['facebookdata.Interest']"}),
        ...
        'facebookdata.interest': {
            'Meta': {'object_name': 'Interest'},
            'category': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'fb_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'}),
            'in_profile': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
